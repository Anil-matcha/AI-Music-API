...
[Muapi AI Music API landing page](https://muapi.ai/ai-music-api) · [API reference](https://muapi.ai/docs/api-reference) · [Create an API key](https://muapi.ai/access-keys)
...
- [Muapi AI Music API](https://muapi.ai/ai-music-api)
